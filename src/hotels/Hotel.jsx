...
function Hotel() {
  ...
  return (
    <div>
      <Navbar/>
      <Header type="list" />
      <div className="hotel-container  flex justify-center my-5">
       { open && <div className="hotel-slider w-full h-[20vh]">
        ...
        <div className="hotel-wrapper flex w-full max-w-screen-xl flex-col gap-4">
          ...
          <h1 className='hotel-title text-2xl text-blue-400 font-bold mt-1'>Grand Hotel</h1>
          <div className='hotel-address text-[12px] flex items-center gap-[5px] mt-[-8px]'>
            <FontAwesomeIcon icon={faLocationDot} className='pl-1'/>
            <span>Elton 25 New Yourk</span>
          </div>
            <span className='hotel-distance mt-[-9px] text-blue-500 font-[500]'>Excellent location from 500m</span>
            <span className="hotelpicture-highlight bg-green-600 text-white w-max ml-[-1px] rounded-md mt-[-10px] mb-[5px] text-[14px] px-[4px]">
              Book a stay over $144 of this property and get free airport texi
            </span>
            </div>
            ...
            <div className="hotel-images flex flex-wrap justify-evenly gap-y-2.5">
              { 
                photos.map((photos,i)=>{
                    return <div key={photos.id} className="hotelimg-wrapper w-[32%]">
                      <img onClick={()=>{handelOpen(i)}} src={photos.src} className='w-full object-cover' alt="" />
                    </div>
                })
              }
            </div>
            <div className="hotels-detail flex justify-between mt-[10px] gap-[10px] ">
              <div className="hoteldetails-text flex-[3]">
                <h1 className="hoteltext-title text-2xl mb-[5px]">Stay In The Heart Of The Hotel</h1>
              ...
              <div className="hoteldetail-price bg-[#b8c4c5eb] mt-[10px] rounded-[10px] flex-[1] flex flex-col">
                <h1 className='text-2xl mt-[5px] ml-[9px]'>Perfect For 9-Night Stand</h1>
                ...
                <strong className='ml-[9px]' >$120 (9 Nights)</strong> 
