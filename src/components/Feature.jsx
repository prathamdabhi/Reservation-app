  ...
  return (
    <div className='feature w-full max-w-screen-lg flex justify-center gap-3'>
        <div className="featureImage ">
            ...
            <span className='font-bold pl-[7px] ' >peoperties 12003</span>
            </div>
        </div>
        <div className="featureImage">
            ...
            <span className='font-bold pl-[7px]' >peoperties 15003</span>
            </div>
        </div>
        <div className="featureImage">
            ...
            <div className="featureTitles text-white  ">
            <h1 className='text-2xl pl-[7px] font-bold' >Banglor</h1>
            <span className='font-bold pl-[7px]'>peoperties 22003</span>
            </div>
        </div>
